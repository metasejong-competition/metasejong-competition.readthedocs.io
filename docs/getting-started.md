...
## System Architecture
   ...
   2. **Competitor's Application**
      ...
      This is the application that participating teams of MARC 2025 are required to develop. The MARC 2025 organizers provide the following development environment for the teams.
...
## Prerequisites
   ...
   ### Development Tools and Knowledge Requirements
...
## Installation Guide
   ...
   ### Meta-Sejong Platform Installation
   ...
   - Load Docker Image for Meta-Sejong Platform

      1. **Download Docker Image File**
         - The following command provides a link to download the Docker image.
         ```bash
         make download
         ```
      ...
      2. **Load Downloaded Docker Image File**

         - Load docker image file using below command.
         ```bash
         make load
         ```

   - Run Meta-Sejong Platform
   ...
   ### Participant Development Environment Setup
...
## Demo Application
   ...
   - Team Information Environment Setup
